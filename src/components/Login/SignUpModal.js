    ...
    //   ];
      return (
        <Modal size='small'
          ...
          onClose={this.close} closeOnDimmerClick={true} >
          ...
          <Modal.Content>
            <Form>
              ...
              <Form.Group widths='equal'>
                <Form.Field required
                  label='Password' control='input' type='password'/>
                <Form.Field required
                  label='Confirm Password' control='input' type='password'/>
              </Form.Group>
            </Form>
          </Modal.Content>
          <Modal.Actions>
            <Button negative
              onClick={()=>this.setState({openState: false})}>
              <Icon name='remove' />Close</Button>
            <Button
              positive
              icon='checkmark'
              content='Create'
